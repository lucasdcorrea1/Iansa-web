                   ...
                   <!--         <div class="col-lg-4 order-lg-3 text-lg-right align-self-lg-center">
                        ...
                        <div class="text-center mt-5">
                            ...
                            <h3 style="padding: 10px;">
                                <span class="font-weight-light">SOBRE A CASA DE APOIO</span>
                            </h3>
                        </div>
                        ...
                        <div class="mt-5 py-5 border-top text-center">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <p>A Casa de Apoio I.A.N.S.A. oferece diariamente refeições à dezenas de pessoas que são gentilmente transportadas, por uma van própria da Instituição, entre o Hospital e o refeitório da  Instituição e ali podem se servir de um delicioso almoço, preparado por uma equipe fantástica que trabalha com muita dedicação e amor.</p>
                                <p>Aos pacientes ou suas famílias que necessitam pernoitar ou até mesmo passar dias na cidade por conta de um tratamento prolongado, a Casa de Apoio oferece hospedagem e toda a assistência que necessitam, acolhendo-os com todo o respeito.</p>
...
<script>
import TabsSection from "./components/JavascriptComponents/TabsSection.vue";
    export default {
      components: {
        TabsSection
      },
